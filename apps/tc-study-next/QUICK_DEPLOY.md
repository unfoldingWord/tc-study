...
# Build and deploy
bun run build && bunx wrangler pages deploy dist --project-name=tc-study-next
```
...
bunx wrangler pages deploy dist --project-name=tc-study-next  # Deploy
```

### 3. Your App is Live! 🎉

After deployment, you'll see:
- Production URL: `https://tc-study-next.pages.dev`
...
# List deployments
bunx wrangler pages deployment list --project-name=tc-study-next

# View logs
bunx wrangler pages deployment tail

# Delete a deployment
bunx wrangler pages deployment delete <deployment-id> --project-name=tc-study-next
```
...
bunx wrangler pages secret put API_KEY --project-name=tc-study-next
