/**
 * Mobile scripture processor — USJ → OptimizedScripture (viewer / Door43 DTO).
 *
...
/** Mobile OptimizedScripture producer over `USJProcessor`. */
export class UsjScriptureProcessor {
  private readonly usj = new USJProcessor()

  /**
   * @deprecated Prefer `USJProcessor.processUSFM` for UsjScriptureViewModel.
   * Process USFM → ProcessedScripture projection (transitional).
   */
  async processUSFM(
    usfmContent: string,
    bookCode: string,
