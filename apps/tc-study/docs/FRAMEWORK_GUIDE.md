...
Resource types **load**. Panel entries **paint**. A viewer on a resource type is not a tab.

See **[extending-registries.md](./extending-registries.md)** for the three-registry model (resources, panel entries, panel modes), CombinedHelps compositions, and persist.
