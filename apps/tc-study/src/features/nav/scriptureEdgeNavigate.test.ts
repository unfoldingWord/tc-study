...
describe('nextEdgeCueVisibility', () => {

  it('mounts the bottom cue whenever canNext (content end; no park-at-edge gate)', () => {
  ...
  it('mounts the top cue whenever canPrev (content start; no park-at-edge gate)', () => {
