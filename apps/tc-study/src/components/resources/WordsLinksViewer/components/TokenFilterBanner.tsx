...
export function TokenFilterBanner({
  ...
  return (
    ...
    >
      ...
      {/* Borderless iOS capsule (nav chrome recipe): soft fill, no outline ring. */}
      <span
        className="inline-flex items-center gap-0.5 min-w-0 max-w-[10rem] h-7 rounded-full bg-accent-soft pl-2.5 pr-1 text-chrome font-medium text-accent-fg"
        title={filterValue}
      >
