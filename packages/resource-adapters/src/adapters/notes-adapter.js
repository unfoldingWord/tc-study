...
var NotesAdapter = /** @class */ (function (_super) {
    __extends(NotesAdapter, _super);
    function NotesAdapter(httpClient) {
        var _this = _super.call(this, httpClient) || this;
        _this.notesProcessor = new resource_parsers_1.NotesProcessor();
        return _this;
    }
    NotesAdapter.prototype.getSupportedTypes = function () {
        return ['Translation Notes', 'TSV Translation Notes', 'translation-notes'];
    };
    NotesAdapter.prototype.fetchAndParse = function (resource_1) {
        return __awaiter(this, arguments, void 0, function (resource, options) {
            var bookCode, bookName, tsvUrl, tsvContent, notes;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        tsvUrl = (0, door43_api_1.getNotesUrl)(resource, bookCode);
                        return [4 /*yield*/, this.downloadContent(tsvUrl)
                            // Parse notes
                        ];
                    case 1:
                        tsvContent = _a.sent();
                        return [4 /*yield*/, this.notesProcessor.processNotes(tsvContent, bookCode, bookName || bookCode)];
                    case 2:
                        notes = _a.sent();
                        return [2 /*return*/, this.createResult(notes, resource, bookCode, bookName)];
                }
            });
        });
    };
